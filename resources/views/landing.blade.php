...
<head>
    ...
    <title>
        carikerja | temukan pekerjaan impian kamu
    </title>
    ...
    <style>
        ...
        .gradient {
            background: linear-gradient(90deg, #107264 0%, #1ec7ae 100%);
        }
    </style>
</head>
    ...
    <nav id="header" class="fixed w-full z-30 top-0 text-white">
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20"
                ...
                <a id="navAction" href="login/option"
    ...
    <div class="pt-24">
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                <p class="uppercase tracking-loose w-full">Cari atau posting pekerjaan</p>
                <h1 class="my-4 text-5xl font-bold leading-tight">
                    bangun karir anda bersama kami!
                </h1>
                <p class="leading-normal text-2xl mb-8">
                    Kami berkomitmen untuk mempermudah anda dalam mencari atau memposting pekerjaan
                </p>
        ...
        <div class="container max-w-5xl mx-auto m-8">
                ...
                <div class="w-full sm:w-1/2 p-6">
                    <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" class="w-5/6 sm:h-64 mx-auto"
                        ...
                        <path
                            ...
                            style="isolation: isolate; user-select: auto;" />
                        <path
                            d="M917.58774,506.70207H844.90243a4.28809,4.28809,0,0,0-4.28325,4.28326v45.2535a4.28813,4.28813,0,0,0,4.28325,4.28326h72.68525a4.28811,4.28811,0,0,0,4.28331-4.28326v-45.2535A4.28805,4.28805,0,0,0,917.58774,506.70207Zm1.40563,32.50616a17.608,17.608,0,0,1-17.31149,17.53912c-7.37524.096,4.08065.13344-4.81443.13344-20.34014,0-41.54928-.19437-49.46265-.32039a3.99033,3.99033,0,0,1-3.908-3.974V510.98868a1.41039,1.41039,0,0,1,1.40535-1.40882h72.68265a1.41023,1.41023,0,0,1,1.40858,1.40505Z"
                            transform="translate(-266.62966 -85.37299)" fill="#e6e6e6" style="user-select: auto;" />
                        <path
                            d="M908.64029,480.64368H853.26173a2.38009,2.38009,0,0,0-2.23738,1.57772l-8.55284,23.99548a2.37533,2.37533,0,0,0,2.234,3.17278l74.27173.13182h.00331a2.3753,2.3753,0,0,0,2.18316-3.31092l-.1295.05544.1295-.05544-10.3403-24.12729A2.3724,2.3724,0,0,0,908.64029,480.64368Z"
                            transform="translate(-266.62966 -85.37299)" fill="#e6e6e6" style="user-select: auto;" />
                        <path
                            d="M921.356,506.73164a2.3816,2.3816,0,0,1-.19231.9359L910.82407,526.24a2.38187,2.38187,0,0,1-2.18374,1.438H853.26258a2.38175,2.38175,0,0,1-2.23929-1.57691l-8.55122-18.44a2.37377,2.37377,0,0,1,1.44017-3.03416,2.33692,2.33692,0,0,1,.79272-.1389l9.07258-.01708,3.703-.00642,48.72608-.08547,3.7051-.00641,9.06617-.01709H918.98A2.37644,2.37644,0,0,1,921.356,506.73164Z"
                            transform="translate(-266.62966 -85.37299)" fill="#e6e6e6" style="user-select: auto;" />
                        <path
                            d="M850.35149,540.64743c1.09814,0,16.17808.92161,16.17808,2.01975s-15.07994,1.957-16.17808,1.957a1.98836,1.98836,0,0,1,0-3.97672Z"
                            transform="translate(-266.62966 -85.37299)" fill="#e6e6e6" style="user-select: auto;" />
                        <path
                            d="M905.19164,466.04609H858.49758a4.72551,4.72551,0,0,0-4.72,4.72v56.91193h54.86279a2.34556,2.34556,0,0,0,1.27136-.36967V470.76613A4.72552,4.72552,0,0,0,905.19164,466.04609Z"
                            transform="translate(-266.62966 -85.37299)" fill="#f2f2f2" style="user-select: auto;" />
                        <path
                            d="M887.36915,469.873H861.77962a4.30331,4.30331,0,0,0-4.29911,4.297v53.5081h48.72608V488.71043A18.85921,18.85921,0,0,0,887.36915,469.873Z"
                            transform="translate(-266.62966 -85.37299)" fill="#fff" style="user-select: auto;" />
                        <path
                            d="M897.90538,522.926H865.78171a1.047,1.047,0,1,0,0,2.094h32.12367a1.047,1.047,0,1,0,0-2.094Z"
                            transform="translate(-266.62966 -85.37299)" fill="#e4e4e4" style="user-select: auto;" />
                        <path
                            d="M897.90538,518.785H865.78171a1.04807,1.04807,0,0,0,0,2.09614h32.12367a1.04807,1.04807,0,1,0,0-2.09614Z"
                            transform="translate(-266.62966 -85.37299)" fill="#e4e4e4" style="user-select: auto;" />
                        <path
                            d="M879.70681,514.64612h-13.9251a1.047,1.047,0,1,0,0,2.094h13.9251a1.047,1.047,0,1,0,0-2.094Z"
                            transform="translate(-266.62966 -85.37299)" fill="#e4e4e4" style="user-select: auto;" />
                        <path
                            d="M897.90538,505.97525H865.78171a1.04807,1.04807,0,0,0,0,2.09613h32.12367a1.04807,1.04807,0,1,0,0-2.09613Z"
                            transform="translate(-266.62966 -85.37299)" fill="#e4e4e4" style="user-select: auto;" />
                        <path
                            d="M897.90538,501.83639H865.78171a1.047,1.047,0,1,0,0,2.094h32.12367a1.047,1.047,0,1,0,0-2.094Z"
                            transform="translate(-266.62966 -85.37299)" fill="#e4e4e4" style="user-select: auto;" />
                        <path
                            d="M879.70681,497.6954h-13.9251a1.04807,1.04807,0,0,0,0,2.09614h13.9251a1.04807,1.04807,0,1,0,0-2.09614Z"
                            transform="translate(-266.62966 -85.37299)" fill="#e4e4e4" style="user-select: auto;" />
                        <path
                            d="M897.90538,489.02453H865.78171a1.04807,1.04807,0,0,0,0,2.09613h32.12367a1.04807,1.04807,0,1,0,0-2.09613Z"
                            transform="translate(-266.62966 -85.37299)" fill="#e4e4e4" style="user-select: auto;" />
                        <path
                            d="M897.90538,484.88568H865.78171a1.04807,1.04807,0,0,0,0,2.09613h32.12367a1.04807,1.04807,0,1,0,0-2.09613Z"
                            transform="translate(-266.62966 -85.37299)" fill="#e4e4e4" style="user-select: auto;" />
                        <path
                            d="M879.70681,480.74468h-13.9251a1.04807,1.04807,0,0,0,0,2.09614h13.9251a1.04807,1.04807,0,1,0,0-2.09614Z"
                            transform="translate(-266.62966 -85.37299)" fill="#e4e4e4" style="user-select: auto;" />
                        <circle cx="267.12389" cy="168.12981" r="30.9975" fill="#ffb6b6"
                            style="user-select: auto;" />
                        <path
                            d="M569.13749,235.7543c-3.26063-5.0444-9.3794-8.40634-15.31111-7.46163a20.90869,20.90869,0,0,0-35.0334-12.19548,6.50171,6.50171,0,0,0-6.35821-.63632,13.40617,13.40617,0,0,0-5.1656,4.14634,30.08788,30.08788,0,0,0-4.21015,30.60908c-.72494-2.6354,1.91618-5.11472,4.58474-5.7061,2.66833-.59139,5.46747-.03191,8.17354-.417,3.46828-.4935,6.586-2.5055,10.05975-2.9583,2.91943-.38054,5.85533.368,8.70226,1.11828,2.84694.75021,5.77529,1.51529,8.69884,1.16814,2.92377-.34715,6.68981,10.73278,6.63927,18.53676-.00961,1.47892.295,3.37772,1.74031,3.69148,1.77988.38648,2.81126-2.07008,4.50538-2.73945a3.13418,3.13418,0,0,1,3.84425,2.04424,5.10984,5.10984,0,0,1-.97559,4.57582,15.09938,15.09938,0,0,1-3.66083,3.17567l.69772.5803c1.1606,1.53324,3.568,1.59967,5.24085.65107a11.31116,11.31116,0,0,0,3.76283-4.28447c3.09483-5.14753,5.80959-10.63216,6.9018-16.53837S572.3979,240.7987,569.13749,235.7543Z"
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                        <polygon points="303.485 710.95 286.745 710.948 278.781 646.376 303.489 646.377 303.485 710.95"
                            fill="#ffb6b6" style="user-select: auto;" />
                        <path
                            ...
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                        <polygon points="333.673 681.391 320.54 691.771 274.246 646.056 293.63 630.733 333.673 681.391"
                            fill="#ffb6b6" style="user-select: auto;" />
                        <path
                        ...
                        <polygon
                            ...
                            fill="#2f2e41" style="user-select: auto;" />
                        <polygon
                            points="322.915 486.545 328.324 499.521 307.409 682.241 278.064 684.384 265.392 480.109 322.915 486.545"
                            fill="#2f2e41" style="user-select: auto;" />
                        <polygon
                            points="294.155 217.278 284.519 203.94 253.405 205.187 252.808 215.457 232.139 410.681 252.437 410.226 277.634 416.109 326.097 399.147 294.155 217.278"
                            fill="#107264" style="user-select: auto;" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-266.62966 -85.37299)" fill="#ffb6b6" style="user-select: auto;" />
                        <polygon
                            ...
                            fill="#3f3d56" style="user-select: auto;" />
                        <path
                            d="M728.72485,394.65842a10.38673,10.38673,0,0,0-15.4297,3.94836L676.618,394.45885l8.69318,17.09781,33.49654,1.31772a10.443,10.443,0,0,0,9.91714-18.21589Z"
                            transform="translate(-266.62966 -85.37299)" fill="#ffb6b6" style="user-select: auto;" />
                        <polygon
                        ...
                        <path
                            ...
                            transform="translate(-266.62966 -85.37299)" fill="#e6e6e6" style="user-select: auto;" />
                        <path
                            d="M591.27643,148.82872a.585.585,0,0,1-.7633-.31646l-1.51923-3.67118a.58428.58428,0,0,1,1.07976-.44683l1.51923,3.67118A.585.585,0,0,1,591.27643,148.82872Z"
                            transform="translate(-266.62966 -85.37299)" fill="#3f3d56" style="user-select: auto;" />
                        <path
                            d="M621.92031,121.63212h0L617.38554,110.674a6.86385,6.86385,0,0,0-8.96684-3.71764l0,0-23.21621,9.60751a6.86386,6.86386,0,0,0-3.71765,8.96685v0l24.87808,60.117a6.86385,6.86385,0,0,0,8.96684,3.71765l0,0,23.21624-9.60752a6.86384,6.86384,0,0,0,3.71764-8.96682l0,0-17.11539-41.35873h0a.4329.4329,0,0,0,.23447-.56554l-2.89685-7.00015A.43291.43291,0,0,0,621.92031,121.63212Z"
                            transform="translate(-266.62966 -85.37299)" fill="#3f3d56" style="user-select: auto;" />
                        <path
                            d="M616.05311,111.27488l24.84233,60.0306a5.12266,5.12266,0,0,1-2.72423,6.67288.2783.2783,0,0,1-.0497.02457l-23.32914,9.65425a5.12861,5.12861,0,0,1-6.69886-2.77735l-24.84233-60.0306a5.12547,5.12547,0,0,1,2.77875-6.69545l2.82922-1.17081a2.43615,2.43615,0,0,0,3.36979,2.23864l13.30075-5.50422a2.37045,2.37045,0,0,0,.77482-.52027,2.42943,2.42943,0,0,0,.02081-3.44213l3.03375-1.25545A5.12469,5.12469,0,0,1,616.05311,111.27488Z"
                            transform="translate(-266.62966 -85.37299)" fill="#107264" style="user-select: auto;" />
                        <path
                            d="M588.68479,142.56613a.585.585,0,0,1-.76329-.31647l-1.51924-3.67117a.58428.58428,0,1,1,1.07976-.44683l1.51924,3.67117A.585.585,0,0,1,588.68479,142.56613Z"
                            transform="translate(-266.62966 -85.37299)" fill="#3f3d56" style="user-select: auto;" />
                        <path
                            d="M585.62772,135.48441a.585.585,0,0,1-.7633-.31646l-1.51923-3.67118a.58428.58428,0,1,1,1.07975-.44683l1.51924,3.67117A.585.585,0,0,1,585.62772,135.48441Z"
                            transform="translate(-266.62966 -85.37299)" fill="#3f3d56" style="user-select: auto;" />
                        <path
                            d="M594.17965,115.50467a.585.585,0,0,1,.31647-.76329l3.67117-1.51924a.58428.58428,0,0,1,.44684,1.07976l-3.67118,1.51924A.585.585,0,0,1,594.17965,115.50467Z"
                            transform="translate(-266.62966 -85.37299)" fill="#fff" style="user-select: auto;" />
                        <circle cx="333.81259" cy="27.54004" r="0.58428" fill="#fff"
                            style="user-select: auto;" />
                        <path
                            d="M727.16164,372.75243c-.07367,0-.14734-.00145-.22174-.00436a5.39058,5.39058,0,0,1-4.33476-2.46533,60.89743,60.89743,0,0,0-12.81991-13.88691c-3.00863-2.40473-6.15264-4.6407-9.19285-6.80336-7.8435-5.577-15.23008-10.82963-19.33039-18.08738-8.93989-15.826,1.58815-37.86924,16.62843-47.75491,16.86977-11.08731,39.05927-12.82644,60.5251-13.05436q3.34633-.03539,6.69666-.0352h0a638.49363,638.49363,0,0,1,115.31057,10.54365c12.64861,2.3336,25.88842,5.19235,36.52788,12.13,10.57631,6.89663,17.00478,17.75712,16.37765,27.66928-.91566,14.47012-16.255,25.28234-30.22282,28.10915-13.31348,2.69216-27.14413.87283-41.78627-1.05393-3.23256-.425-6.57472-.86485-9.87987-1.247-35.92-4.15184-103.398,8.6452-106.25272,9.19213l-2.83226.5422L731.365,370.68776A5.27374,5.27374,0,0,1,727.16164,372.75243Z"
                            transform="translate(-266.62966 -85.37299)" fill="#107264" style="user-select: auto;" />
                        <path
                            d="M887.11731,302.16215H735.2958a3.3033,3.3033,0,0,1,0-6.6066H887.11731a3.3033,3.3033,0,0,1,0,6.6066Z"
                            transform="translate(-266.62966 -85.37299)" fill="#fff" style="user-select: auto;" />
                        <path
                            d="M887.11731,322.43821H735.2958a3.30331,3.30331,0,0,1-.00689-6.60661h151.8284a3.30331,3.30331,0,0,1,0,6.60661Z"
                            transform="translate(-266.62966 -85.37299)" fill="#fff" style="user-select: auto;" />
                        <path
                            d="M752.98834,342.71379H735.2958a3.30331,3.30331,0,0,1,0-6.60661h17.69254a3.30331,3.30331,0,0,1,0,6.60661Z"
                            transform="translate(-266.62966 -85.37299)" fill="#fff" style="user-select: auto;" />
                        <circle cx="462.40689" cy="294.35216" r="16.05687" fill="#fff"
                            style="user-select: auto;" />
                        <path
                            d="M729.03656,395.97811a16.25289,16.25289,0,1,1,16.25289-16.253A16.27142,16.27142,0,0,1,729.03656,395.97811Z"
                            transform="translate(-266.62966 -85.37299)" fill="#3f3d56" style="user-select: auto;" />
                        <path
                            d="M727.83438,386.1424c-.03423,0-.06847-.00111-.1027-.00278a2.09978,2.09978,0,0,1-1.55654-.80875l-2.68338-3.44982a2.10062,2.10062,0,0,1,.3682-2.94832l.09657-.07514a2.1004,2.1004,0,0,1,2.94888.36847,1.53224,1.53224,0,0,0,2.32047.113l5.44831-5.75193a2.10375,2.10375,0,0,1,2.9703-.08071l.08934.08516a2.10038,2.10038,0,0,1,.08015,2.97l-8.45507,8.92456A2.09844,2.09844,0,0,1,727.83438,386.1424Z"
                            transform="translate(-266.62966 -85.37299)" fill="#fff" style="user-select: auto;" />
                        <path
                            d="M429.22188,172.166l-9.82351-59.0756a4.577,4.577,0,0,1,3.76-5.25986l44.6152-7.41893a4.577,4.577,0,0,1,5.25983,3.76l9.8235,59.07561a4.577,4.577,0,0,1-3.75994,5.25984l-44.6152,7.41893A4.577,4.577,0,0,1,429.22188,172.166Z"
                            transform="translate(-266.62966 -85.37299)" fill="#3f3d56" style="user-select: auto;" />
                        <path
                            d="M429.677,153.75359l-6.31544-37.97916a4.28642,4.28642,0,0,1,3.52132-4.926l38.343-6.376a4.28661,4.28661,0,0,1,4.92622,3.5213l8.74159,52.56925a4.28661,4.28661,0,0,1-3.52154,4.926l-23.7527,3.94977A19.09378,19.09378,0,0,1,429.677,153.75359Z"
                            transform="translate(-266.62966 -85.37299)" fill="#fff" style="user-select: auto;" />
                        <path
                            d="M431.33193,125.339a4.18859,4.18859,0,0,1,3.441-4.81367l26.59846-4.423a4.184,4.184,0,1,1,1.37265,8.2547L436.1456,128.78A4.1886,4.1886,0,0,1,431.33193,125.339Z"
                            transform="translate(-266.62966 -85.37299)" fill="#107264" style="user-select: auto;" />
                        <path
                            d="M433.46716,138.17959a4.1886,4.1886,0,0,1,3.441-4.81367l26.59847-4.423a4.184,4.184,0,0,1,1.37265,8.2547l-26.59847,4.423A4.1886,4.1886,0,0,1,433.46716,138.17959Z"
                            transform="translate(-266.62966 -85.37299)" fill="#107264" style="user-select: auto;" />
                        <path
                            d="M435.60239,151.02023a4.1886,4.1886,0,0,1,3.441-4.81367l26.59847-4.423a4.184,4.184,0,0,1,1.37265,8.2547l-26.59847,4.423A4.1886,4.1886,0,0,1,435.60239,151.02023Z"
                            transform="translate(-266.62966 -85.37299)" fill="#107264" style="user-select: auto;" />
                        <path
                            d="M662.32646,772.97087l.70715-15.90017a51.35277,51.35277,0,0,1,23.95261-6.06333c-11.504,9.40539-10.06637,27.53575-17.86583,40.18378a30.8888,30.8888,0,0,1-22.65105,14.27412l-9.627,5.89429a51.75978,51.75978,0,0,1,10.90965-41.9429,49.99707,49.99707,0,0,1,9.18851-8.53763C659.2462,766.95864,662.32646,772.97087,662.32646,772.97087Z"
                            transform="translate(-266.62966 -85.37299)" fill="#f2f2f2" style="user-select: auto;" />
                        <path
                            d="M789.969,813.07379a1.54861,1.54861,0,0,1-1.5533,1.55322H370.36555a1.55322,1.55322,0,1,1,0-3.10644H788.41572A1.54866,1.54866,0,0,1,789.969,813.07379Z"
                            transform="translate(-266.62966 -85.37299)" fill="#ccc" style="user-select: auto;" />
                        <path
                            d="M371.373,393.65688c-7.41429-.14769-47.23975-1.29075-53.77054-1.00965-.36943-1.2933-12.74985,14.57255-13.05093,14.67089a1.80834,1.80834,0,0,0,.60481,2.90759c.72777.44213,64.93166-.74561,65.70956-.59064a1.7859,1.7859,0,0,0,1.59378-1.03833l.42914-.96116c.04458-1.64431.58291-10.048.09965-11.48483A1.77814,1.77814,0,0,0,371.373,393.65688Z"
                            transform="translate(-266.62966 -85.37299)" fill="#3f3d56" style="user-select: auto;" />
                        <path
                            d="M372.88872,407.63407c-.37681.90548-.85882,2.04315-2.02291,2.00137l-65.03159.72981a1.7939,1.7939,0,0,1-1.56527-2.63308Z"
                            transform="translate(-266.62966 -85.37299)" opacity="0.17"
                            style="isolation: isolate; user-select: auto;" />
                        <path
                            d="M317.90631,392.45252c-.7-1.21052-18.08617-87.2383-19.53727-87.95769l-11.87032-14.52105-1.06094-.79779c-1.47535-.81046-5.01435-.26247-4.69564,1.99087h0c2.7887,13.37007,20.7256,89.51848,21.11867,101.39039L304.02,407.68153a1.86252,1.86252,0,0,0,2.29966,1.52983,3.58266,3.58266,0,0,0,2.87739-2.07912C309.35886,406.59851,318.7191,392.76241,317.90631,392.45252Z"
                            transform="translate(-266.62966 -85.37299)" fill="#3f3d56" style="user-select: auto;" />
                        <path
                            d="M286.49585,289.9744l22.70338,117.16092c-.75925,1.92173-4.312,3.26805-5.13947.74718-.01447-.00347-23.29115-116.64351-23.31482-116.71324C280.49694,288.36213,285.1354,288.27309,286.49585,289.9744Z"
                            transform="translate(-266.62966 -85.37299)" opacity="0.17"
                            style="isolation: isolate; user-select: auto;" />
                        <polygon points="20.55 209.392 32.081 225.464 45.023 286.929 39.006 292.177 20.55 209.392"
                            fill="#107264" style="user-select: auto;" />
                        <path
                            d="M363.93011,401.94452l3.19.13a12.53882,12.53882,0,0,1,.46-2.76c.48-2.28.91-4.99-1.08-4.98-1.35-.13-1.81,1.58-2.05,3.44A26.3201,26.3201,0,0,1,363.93011,401.94452Z"
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                        <path
                            d="M345.63012,397.65454l2.15.08,1.04.04c-.02-1.14.51-3.49-.78-4.07a1.60015,1.60015,0,0,0-.65-.13c-1.21-.07-1.57.85-1.68,1.91-.07.64-.04,1.32-.06,1.85C345.65008,397.44452,345.64013,397.55451,345.63012,397.65454Z"
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                        <path
                            d="M339.26012,397.39453l2.16.09,1.03.04c-.02-1.31.67-4.17005-1.43006-4.21-1.94-.11-1.69,2.36-1.74,3.76C339.28008,397.18451,339.27007,397.2945,339.26012,397.39453Z"
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                        <path
                            d="M332.89013,397.14453l2.15.08,1.04.04c-.02-1.3.67-4.16-1.43-4.2-1.94-.12-1.69,2.35-1.74,3.76C332.91009,396.93451,332.90008,397.0445,332.89013,397.14453Z"
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                        <path
                            d="M326.52007,396.88452l2.16.09,1.03.04c-.02-1.31.67-4.16-1.43-4.21-1.94-.11-1.69,2.36-1.74,3.76C326.54009,396.6745,326.53008,396.78455,326.52007,396.88452Z"
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                        <path
                            d="M320.15008,396.63452l2.15.08,1.04.04c-.02-1.2.56-3.71-.98-4.14h-.01a1.46425,1.46425,0,0,0-.44-.06,1.5059,1.5059,0,0,0-.54.05h-.01c-1.34.35-1.15,2.45-1.19,3.71C320.1701,396.4245,320.16009,396.53455,320.15008,396.63452Z"
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                        <path
                            d="M357.50011,395.95453l3.19.13c0-.12,0-.25.01-.4a13.33143,13.33143,0,0,0,.04-2.29c-.11-.84-.47-1.5-1.48-1.52-1.03-.06-1.44.6-1.6,1.45a3.11452,3.11452,0,0,0-.08.44v.01C357.50011,394.55451,357.5501,395.39453,357.50011,395.95453Z"
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                        <path
                            d="M351.13012,395.69452l3.19.13a23.28057,23.28057,0,0,0,.06-2.58c-.09-.88-.44-1.6-1.49-1.62-1.06006-.07-1.47.65-1.63,1.54C351.1101,394.02454,351.19012,395.05451,351.13012,395.69452Z"
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                        <path
                            d="M344.76012,395.44452l.95.04,2.24.09c-.01-.48.07995-1.18.09-1.87a4.23306,4.23306,0,0,0-.02-.62c-.07995-.93-.41-1.7-1.5-1.72-1.11-.06-1.5.71-1.63995,1.65C344.7401,393.85449,344.82012,394.82453,344.76012,395.44452Z"
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                        <path
                            d="M357.56011,401.69452l3.19.12c-.01-1.3.67-4.16-1.43-4.2C357.22008,397.4845,357.68011,400.38452,357.56011,401.69452Z"
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                        <path
                            d="M351.19012,401.43451l3.19.13c-.01-1.31.67-4.17-1.43-4.21C350.85009,397.2345,351.31011,400.13452,351.19012,401.43451Z"
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                        <path
                            d="M344.82012,401.18451l3.19.12c-.01-.93.34-2.65-.23-3.57a1.31957,1.31957,0,0,0-1.2-.63,1.40551,1.40551,0,0,0-.93.23005C344.63012,398.00452,344.9201,400.12451,344.82012,401.18451Z"
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                        <path
                            d="M338.45013,400.9245l3.19.13c-.01-.93.32995-2.64-.22-3.57a1.3234,1.3234,0,0,0-1.21-.63995,1.3893,1.3893,0,0,0-.93.23C338.26012,397.76453,338.5501,399.87451,338.45013,400.9245Z"
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                        <path
                            d="M332.08007,400.6745l3.19.12c-.01-.93.34-2.65-.23-3.57a1.3193,1.3193,0,0,0-1.2-.63,1.4051,1.4051,0,0,0-.93.23C331.89013,397.49451,332.18011,399.6145,332.08007,400.6745Z"
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                        <path
                            d="M325.71008,400.41455l3.19.13c-.01-.93.33-2.64-.22-3.57a1.31241,1.31241,0,0,0-1.21-.64,1.38919,1.38919,0,0,0-.93.23C325.52007,397.25452,325.81011,399.3645,325.71008,400.41455Z"
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                        <path
                            d="M319.34008,400.16455l3.19.12c-.01-.93006.33-2.64-.23-3.57a1.30821,1.30821,0,0,0-1.2-.63,1.40491,1.40491,0,0,0-.93.23C319.15008,396.99451,319.44012,399.10449,319.34008,400.16455Z"
                            transform="translate(-266.62966 -85.37299)" fill="#2f2e41" style="user-select: auto;" />
                    </svg>
                </div>
            </div>
            <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" class="w-5/6 sm:h-64 mx-auto"
                        height="873.97852" viewBox="0 0 1176.60617 873.97852"
                        xmlns:xlink="http://www.w3.org/1999/xlink" style="user-select: auto;">
                        <title style="user-select: auto;">connected world</title>
                        <path
                            ...
                            transform="translate(-11.69692 -13.01074)" fill="#f2f2f2" style="user-select: auto;" />
                        <path
                            ...
                            transform="translate(-11.69692 -13.01074)" fill="#3f3d56" style="user-select: auto;" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-11.69692 -13.01074)" fill="none" stroke="#6c63ff"
                            stroke-miterlimit="10" stroke-width="2" opacity="0.8" style="user-select: auto;" />
                        <path
                            ...
                            transform="translate(-11.69692 -13.01074)" fill="none" stroke="#6c63ff"
                            stroke-miterlimit="10" stroke-width="2" opacity="0.8" style="user-select: auto;" />
                        <circle cx="214.07353" cy="310.64667" r="11.96804" fill="#107264"
                            style="user-select: auto;" />
                        <circle cx="322.19856" cy="566.51505" r="11.96804" fill="#107264"
                            style="user-select: auto;" />
                        <circle cx="780.69818" cy="308.99591" r="11.96804" fill="#107264"
                            style="user-select: auto;" />
                        <circle cx="991.17056" cy="607.78414" r="11.96804" fill="#107264"
                            style="user-select: auto;" />
                        <circle cx="600.35225" cy="480.67534" r="11.96804" fill="#107264"
                            style="user-select: auto;" />
                    </svg>
                </div>
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <div class="align-middle">
                        ...
                        <p class="text-gray-600 mb-8">
                            Dapatkan akses untuk bertemu dan melamar pekerjaan atau merekrut tenaga ahli dari seluruh
                            dunia
                ...
                <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                    <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                        ...
                        <p class="text-gray-800 text-base px-6 mb-5">
                            Dapatkan akses terhadap calon perusahaan atau calon karyawan dengan mudah
                        </p>
                    </a>
                </div>
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                    <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                        ...
                        <p class="text-gray-800 text-base px-6 mb-5">
                            kami menawarkan pelayanan yang dapat membuat anda memperoleh pekerjaan atau karyawan dengan
                            cepat
                        </p>
                    </a>
                </div>
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                    <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                        ...
                        <div class="w-full font-bold text-xl text-gray-800 px-6">
                            Dapatkan fleksibilitas dalam penggunaan
                        </div>
                        <p class="text-gray-800 text-base px-6 mb-5">
                            Pekerjaan impian anda sudah menunggu, segera daftar di aplikasi dan lamar pekerjaan anda!!
                        </p>
                    </a>
                </div>
